from sqlalchemy import Column, Integer, String, ForeignKey, create_engine, Table, DateTime, Date, Float
...
class Prekes(Base):
    ...
    kaina_vnt = Column("kaina_eur", Float)
    kaina_viso = Column("kaina_is_viso", Float) 
    uzsakymai = relationship("Uzsakymas", back_populates = "preke")
...
class Uzsakymas(Base):
    ...
    preke = relationship("Prekes", back_populates = "uzsakymai")
